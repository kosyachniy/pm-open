...
if ($f==true)
	...
	if ($_SESSION['ban']>=50)
		...
		mail ($log, 'Вы успешно зарегистрировались на сайте PM-Open', 'Ваш логин: '.$log.'<br> Ваш пароль: '.$pas.' 
 Благодарим вас за регистрацию на сайте PM-Open', 'Вы успешно зарегистрировались на сайте PM-Open');
		}
	}
?>